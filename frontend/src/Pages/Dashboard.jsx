  ...
  return (
    <div className="bg-gray-900 text-gray-100 min-h-screen font-['Inter']">
      <div className="flex h-screen overflow-hidden">
        {/* Sidebar */}
        <nav 
          className={`${sidebarCollapsed ? 'w-20' : 'w-64'} bg-gray-800 border-r border-gray-700 flex-shrink-0 relative transition-all duration-300`} 
          style={{ marginTop: '64px' }}
        >
          <div className={`${sidebarCollapsed ? 'px-3 py-4' : 'p-4'} space-y-6 transition-all duration-300`}>
            <div className="space-y-4">
              <div className="px-3">
                {!sidebarCollapsed && <h2 className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Menu</h2>}
              </div>
              <div className="space-y-1">
                <a href="#" className="flex items-center px-3 py-2 text-sm font-medium rounded-lg bg-gray-700 text-white">
                  <i className="fas fa-home w-5 h-5 mr-3"></i>
                  {!sidebarCollapsed && <span>Dashboard</span>}
                </a>
                <a href="#" className="flex items-center px-3 py-2 text-sm font-medium rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white">
            ...
            <div className="space-y-4">
              <div className="px-3">
                {!sidebarCollapsed && <h2 className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Tools</h2>}
              </div>
              <div className="space-y-1">
                <a href="#" className="flex items-center px-3 py-2 text-sm font-medium rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white">
                  <i className="fas fa-file-alt w-5 h-5 mr-3"></i>
                  {!sidebarCollapsed && <span>Resume Builder</span>}
                </a>
                <a href="#" className="flex items-center px-3 py-2 text-sm font-medium rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white">
                  <i className="fas fa-comments w-5 h-5 mr-3"></i>
                  {!sidebarCollapsed && <span>Interview Prep</span>}
                </a>
              </div>
            </div>
          </div>
          ...
          <button 
            className="absolute right-0 top-8 w-5 h-5 flex items-center justify-center bg-gray-700 rounded-l-lg text-gray-400 hover:text-white transform translate-x-full"
        ...
        <div className="flex-1 flex flex-col" style={{ paddingTop: '64px' }}>
          {/* Header */}
          <header className="bg-gray-800 border-b border-gray-700" style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 10 }}>
            <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex justify-between h-16">
                <div className="flex">
                  ...
                  <div className="ml-6 flex items-center">
                    <div className="relative">
                      ...
                      <input 
                        type="text" 
                        className="!rounded-button bg-gray-700 border-0 pl-10 pr-4 py-2 w-96 text-sm text-gray-300 placeholder-gray-400 focus:ring-2 focus:ring-custom focus:bg-gray-600" 
                ...
                <div className="flex items-center space-x-4">
                  <button className="!rounded-button relative p-2 text-gray-400 hover:text-white">
                    <i className="fas fa-bell"></i>
                    <span className="absolute top-1 right-1 block h-2 w-2 rounded-full bg-red-500"></span>
                  </button>
                  <div className="relative">
                    <button className="!rounded-button flex items-center space-x-3 bg-gray-700 px-3 py-2">
                      <img 
                ...
                <div className="w-1/3">
                  <div className="bg-gray-800 rounded-lg p-4 h-full">
                    ...
                    <h3 className="font-semibold text-lg mb-4 flex items-center">
                      <i className="fas fa-paper-plane mr-2 text-custom"></i>
                      Applied
                      <span className="ml-auto bg-gray-700 text-sm px-2 py-1 rounded-full">12</span>
                    </h3>
                    <div className="space-y-4">
                      <div className="bg-gray-700 p-4 rounded-lg">
                        <div className="flex items-start justify-between">
                          <img src="/api/placeholder/40/40" className="w-10 h-10 rounded" alt="Company logo" />
                          <span className="text-xs font-medium bg-custom/10 text-custom px-2 py-1 rounded">New</span>
                        </div>
                        <h4 className="font-medium mt-3">Senior Frontend Developer</h4>
                        <p className="text-sm text-gray-400 mt-1">TechCorp Inc.</p>
                        <div className="flex items-center mt-3 text-sm text-gray-400">
                          <i className="fas fa-location-dot mr-1"></i>
                          Remote
                        </div>
                        <div className="flex items-center justify-between mt-4">
                          <span className="text-xs text-gray-400">Applied 2d ago</span>
                          <button className="!rounded-button text-sm bg-gray-600 px-3 py-1 hover:bg-gray-500">
                      ...
                      <div className="bg-gray-700 p-4 rounded-lg">
                        <div className="flex items-start justify-between">
                          <img src="/api/placeholder/40/40" className="w-10 h-10 rounded" alt="Company logo" />
                          <span className="text-xs font-medium bg-yellow-500/10 text-yellow-500 px-2 py-1 rounded">Follow up</span>
                        </div>
                        <h4 className="font-medium mt-3">Product Designer</h4>
                        <p className="text-sm text-gray-400 mt-1">Design Studio X</p>
                        <div className="flex items-center mt-3 text-sm text-gray-400">
                          <i className="fas fa-location-dot mr-1"></i>
                          New York, NY
                        </div>
                        <div className="flex items-center justify-between mt-4">
                          <span className="text-xs text-gray-400">Applied 5d ago</span>
                          <button className="!rounded-button text-sm bg-gray-600 px-3 py-1 hover:bg-gray-500">
                            <i className="fas fa-ellipsis-h"></i>
                          </button>
                        </div>
                ...
                <div className="w-1/3">
                  <div className="bg-gray-800 rounded-lg p-4 h-full">
                    ...
                    <h3 className="font-semibold text-lg mb-4 flex items-center">
                      ...
                      Interview Scheduled
                      <span className="ml-auto bg-gray-700 text-sm px-2 py-1 rounded-full">3</span>
                    </h3>
                    <div className="space-y-4">
                      <div className="bg-gray-700 p-4 rounded-lg">
                        <div className="flex items-start justify-between">
                          <img src="/api/placeholder/40/40" className="w-10 h-10 rounded" alt="Company logo" />
                          <span className="text-xs font-medium bg-blue-500/10 text-blue-500 px-2 py-1 rounded">Tomorrow</span>
                        </div>
                        <h4 className="font-medium mt-3">Full Stack Engineer</h4>
                        <p className="text-sm text-gray-400 mt-1">Innovation Labs</p>
                        <div className="flex items-center mt-3 text-sm text-gray-400">
                          <i className="fas fa-video mr-1"></i>
                          Remote Interview
                        </div>
                        <div className="flex items-center justify-between mt-4">
                          <span className="text-xs text-gray-400">10:00 AM EST</span>
                          <button className="!rounded-button text-sm bg-gray-600 px-3 py-1 hover:bg-gray-500">
                            <i className="fas fa-ellipsis-h"></i>
                          </button>
                        </div>
                ...
                <div className="w-1/3">
                  <div className="bg-gray-800 rounded-lg p-4 h-full">
                    ...
                    <h3 className="font-semibold text-lg mb-4 flex items-center">
                      ...
                      Offer Received
                      <span className="ml-auto bg-gray-700 text-sm px-2 py-1 rounded-full">2</span>
                    </h3>
                    <div className="space-y-4">
                      <div className="bg-gray-700 p-4 rounded-lg">
                        <div className="flex items-start justify-between">
                          <img src="/api/placeholder/40/40" className="w-10 h-10 rounded" alt="Company logo" />
                          <span className="text-xs font-medium bg-green-500/10 text-green-500 px-2 py-1 rounded">New Offer</span>
                        </div>
                        <h4 className="font-medium mt-3">UI/UX Designer</h4>
                        <p className="text-sm text-gray-400 mt-1">Creative Solutions</p>
                        <div className="flex items-center mt-3 text-sm text-gray-400">
                          <i className="fas fa-dollar-sign mr-1"></i>
                          120K - 150K
                        </div>
                        <div className="flex items-center justify-between mt-4">
                          <span className="text-xs text-gray-400">Expires in 5 days</span>
                          <button className="!rounded-button text-sm bg-gray-600 px-3 py-1 hover:bg-gray-500">
                            <i className="fas fa-ellipsis-h"></i>
                          </button>
                        </div>
              ...
              <div className="w-80 flex-shrink-0">
                <div className="bg-gray-800 rounded-lg p-4">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <h4 className="text-sm font-medium text-gray-400 mb-3">Application Success Rate</h4>
                      <div className="bg-gray-700 rounded-lg p-4">
                        ...
                        <div className="w-full bg-gray-600 rounded-full h-2">
                          <div className="bg-custom h-2 rounded-full" style={{ width: '42%' }}></div>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Suggested Actions */}
                    <div>
                      <h4 className="text-sm font-medium text-gray-400 mb-3">Suggested Actions</h4>
                      <div className="space-y-3">
                        <div className="bg-gray-700 rounded-lg p-3 flex items-start">
                          <i className="fas fa-bell text-yellow-500 mt-1"></i>
                          <div className="ml-3">
                            <p className="text-sm">Follow up with TechCorp Inc. about your application</p>
                            <span className="text-xs text-gray-400">Recommended time: Tomorrow</span>
                          </div>
                        </div>
                        <div className="bg-gray-700 rounded-lg p-3 flex items-start">
                          <i className="fas fa-file-alt text-blue-500 mt-1"></i>
                          <div className="ml-3">
                            <p className="text-sm">Update your resume with recent project highlights</p>
                            <span className="text-xs text-gray-400">Last updated 2 weeks ago</span>
                          </div>
                        </div>
                      </div>
                    </div>
